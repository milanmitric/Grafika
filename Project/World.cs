...
namespace RacunarskaGrafika.Vezbe.AssimpNetSample
{
    ...
    public class World : IDisposable
    {
        ...
        /// </summary>
        private float m_sceneDistance = 270;
        ...
        public World(String scenePath, String sceneFileName, int width, int height)
        {
            ...
            try
            {
                m_font = new OutlineFont("Verdana", 14, 0.5f, false, true, true, false);
            }
            catch (Exception)
            {
        ...
        public void Draw()
        {
            ...
            Gl.glTranslatef(-130f, 0f, 0f);
                ...
                bool first = true;
                Gl.glTranslatef(-15f, 10f, 0f);
                foreach (String msg in m_message)
                {
                    if (!first)
                    {
                    ...
                    Gl.glTranslatef(-0.6f * m_font.CalculateTextWidth(msg), 0.0f, 0.0f); // centriraj tekst
